...
def build_memory(args, model, dataset_name, data_loader, len_dataset, features_shape):
    ...
    if os.path.isfile(f'center_embedding/{model_name}{dataset_name}{args.shot}_embeddings.pt'):
        print('******** Loaded Already Saved center Embeddings *********')
        center = torch.load(f'center_embedding/{model_name}{dataset_name}{args.shot}_embeddings.pt')
        features = torch.load(f'center_embedding/{model_name}{dataset_name}{args.shot}_features.pt')
        labels = torch.load(f'center_embedding/{model_name}{dataset_name}{args.shot}_labels.pt')
        ...
        torch.save(center, f'center_embedding/{model_name}{dataset_name}{args.shot}_embeddings.pt')
        torch.save(features, f'center_embedding/{model_name}{dataset_name}{args.shot}_features.pt')
        torch.save(labels, f'center_embedding/{model_name}{dataset_name}{args.shot}_labels.pt')
